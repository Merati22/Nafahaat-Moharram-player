        ...
        <div class="player__top">
            <div class="player-cover">
                <transition-group :name="transitionName">
                    <div class="player-cover__item" v-if="$index === currentTrackIndex" :style="{ backgroundImage: `url(${track.genre.cover_path})` }"  v-for="(track, $index) in tracks" :key="$index"></div>
                    {{--                    <div class="player-cover__item"  style="background-image: url( '{{ asset($tracks[0]->genre->cover_path) }}')  "></div>--}}
                    {{--                    <div class="player-cover__item"  :style="{ backgroundImage : `url(   {{ asset($tracks[0]->genre->cover_path) }}   )` }" ></div>--}}
                    {{--                        <img class="player-cover__item" src="../img/Rozeh.png"/>--}}
                </transition-group>
            </div>
            <div class="player-controls">
                ...
                <a :href="currentTrack.path" target="_blank" class="player-controls__item" download>
                    <svg  class="icon-download" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 16L12 8" stroke="#c7c7c7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M9 13L11.913 15.913V15.913C11.961 15.961 12.039 15.961 12.087 15.913V15.913L15 13" stroke="#c7c7c7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M3 15L3 16L3 19C3 20.1046 3.89543 21 5 21L19 21C20.1046 21 21 20.1046 21 19L21 16L21 15" stroke="#c7c7c7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </a>
        ...
        <div class="progress" ref="progress">
            <div class="progress__top">
                <div class="album-info" v-if="currentTrack">
                    <div class="album-info__name" >@{{ currentTrack.artist.name }}</div>
        ...
        data() {
            return {
                ...
                {{--tracks: [--}}
                    ...
                    {{--        // cover: "../img/Rozeh.png",--}}
                    {{--        cover: "../" + @json($tracks[0]->genre->cover_path),--}}
                    {{--        source: "../" + @json($tracks[0]->path),--}}
                    {{--        url: "https://www.youtube.com/watch?v=z3wAjJXbYzA",--}}
                    {{--        favorited: false--}}
                    {{--    },--}}
                    {{--    {--}}
                    {{--        name: @json($tracks[1]->name),--}}
                    {{--        artist: @json($tracks[1]->artist->name),--}}
                    {{--        cover: "../" + @json($tracks[1]->genre->cover_path),--}}
                    {{--        source: "../" + @json($tracks[1]->path),--}}
                    {{--        url: "https://www.youtube.com/watch?v=Lin-a2lTelg",--}}
                    {{--        favorited: true--}}
                    {{--    },--}}
                    {{--    {--}}
                    {{--        name: @json($tracks[2]->name),--}}
                    {{--        artist: @json($tracks[2]->artist->name),--}}
                    {{--        cover: "../" + @json($tracks[2]->genre->cover_path),--}}
                    {{--        source: "../" + @json($tracks[2]->path),--}}
